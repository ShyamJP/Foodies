      ...
      <div className="container-fluid footer  text-secondary mt-5 pt-5">
        <div className="row px-xl-5 pt-5">
          <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p className="mb-0"><i className="fa fa-phone-alt text-primary mr-3"></i>+91 9173800556</p>
          </div>
        ...
        <div class="row border-top mx-xl-5 py-4" style={{ "border-color": "rgba(256, 256, 256, .1) !important" }}>
          <div class="col-md-12  px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-secondary w-100">
              &copy; <a className="text-primary" href="#">Hungry Up</a>. All Rights Reserved. Designed by
